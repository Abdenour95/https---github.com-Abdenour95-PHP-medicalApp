        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-info" style="min-height: 80px;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link btn btn-info text-light" href="index.php?p=8">
                            Liste des Patients 
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-info text-light" href="index.php?p=15">
                            Liste des Rendez-vous
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-info text-light" href="index.php?p=1">
