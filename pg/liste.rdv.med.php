...
include("inc/tri.rdv.med.inc.php");
?>
            ...
            <div class="row">
                <div class="col-12 py-2 text-dark" style="background-color: #dee2e6;">
                    ...
                    <div class="float-right">
                        <div class="row">
                    		<div class="dropdown">
                        		<button aria-expanded="false" title="Trier La liste des Rendez-vous" style="width: 140px;" aria-haspopup="true" class="btn btn-info dropdown-toggle m-1" data-toggle="dropdown" id="dropdownMenuButton" type="button">
                            		Trier Par
                        		</button>
                        		<div aria-labelledby="dropdownMenuButton" class="dropdown-menu">
                            <a class="dropdown-item d-none d-lg-block" href="index.php?p=15&tri=1" >
                                Numéro
                            </a>
                            <a class="dropdown-item" href="index.php?p=15&tri=2">
                                Nom
                            </a>
                            <a class="dropdown-item d-none d-lg-block" href="index.php?p=15&tri=3">
                                Prénom
                            </a>
                            <a class="dropdown-item " href="index.php?p=15&tri=4">
                                Date
                            </a>
                            <a class="dropdown-item " href="index.php?p=15&tri=5">
                                Heure
                            </a>
                            <a class="dropdown-item " href="index.php?p=15&tri=6">
                                Etat
                            </a>
                        	</div>
                    		</div>
                    		<div>
                            <a class="btn btn-info m-1" title="Actualiser La Liste des Patients" href="index.php?p=15" style="width: 140px;">
                ...
                <div class="col-lg-2 col-sm-12 text-center text-dark border border-bottom-0 border-left-0 border-top-0 bg-light search-height">
					...
					<form class="form-group text-left mx-auto" enctype="multipart/form-data" method="post" action="index.php?p=15" accept-charset="utf-8">
                        ...
                        <label class="form-check-label d-none d-lg-block" ><input class="form-check-input" type="radio" id="radio1" name="filtre" value="num_rdv" checked="checked">Numéro</label>
                        </div>
                        ...
                        <label class="form-check-label d-none d-lg-block"><input class="form-check-input" type="radio" id="radio3" name="filtre" value="prenom">Prénom</label>
                        </div>
                        <div class="form-check" for="radio4">
                        <label class="form-check-label"><input class="form-check-input" type="radio" id="radio4" name="filtre" value="date_rdv">Date</label>
                        </div>
                        <div class="form-check" for="radio5">
                        <label class="form-check-label"><input class="form-check-input" type="radio" id="radio5" name="filtre" value="heure">Heure</label>
                        </div>
                        <div class="form-check" for="radio6">
                        <label class="form-check-label"><input class="form-check-input" type="radio" id="radio6" name="filtre" value="etat">Etat</label>
                        </div>
				  ...
				  if (($_POST["search"])!=''){
					...
					switch ($filtre):
                                ...
                                case 'prenom':
                                    ...
                                    break;
                                case 'date_rdv':
                                    $print="Résultats De La Recherche De la Date : ";
                                    break;
                                case 'heure':
                                    $print="Résultats De La Recherche De l'Heure : ";
                                    break;
                                case 'etat':
                                    $print="Résultats De La Recherche De l'Etat : ";
                                    break;
                                case '':
                    ...
                    <div class="row col-lg-12 text-center font-weight-bold mx-1" style="border-bottom: solid 2px grey;">
                        ...
                        <div class=" col-lg-1">
                            Date <?php echo $titre4;?>
                        </div>
                        <div class="col-lg-1 col-md-3">
                            Heure <?php echo $titre5;?>
                        </div>
                        <div class="col-lg-2 col-md-3">
                            Etat <?php echo $titre6;?>
                        </div>
                        <div class=" col-lg-2 col-md-3 ">
                            Actions
                        </div>                        
		...
		include("inc/bcl.rdv.med.inc.php");
