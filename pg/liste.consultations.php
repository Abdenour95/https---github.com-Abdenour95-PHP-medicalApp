...
include("inc/tri.consultations.inc.php");
?>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 py-2 text-dark" style="background-color: #dee2e6;">
                    ...
                    <div class="float-right">
                        <div class="row">
                            ...
                            <a class="dropdown-item d-none d-lg-block" href="index.php?p=1&tri=1" >
                                Numéro
                            </a>
                            <a class="dropdown-item" href="index.php?p=1&tri=2">
                                Nom
                            </a>
                            <a class="dropdown-item" href="index.php?p=1&tri=3">
                                Prénom
                            </a>
                            <a class="dropdown-item d-none d-lg-block" href="index.php?p=1&tri=4">
                                Motif
                            </a>
                            <a class="dropdown-item " href="index.php?p=1&tri=5">
                                Date
                            </a>
                        	</div>
                    		</div>
                    		...
                    		<div>
                            <a class="btn btn-info m-1" title="Actualiser La Liste des Consultations" href="index.php?p=1" style="width: 140px;">
                ...
                <div class="col-lg-2 col-sm-12 text-center text-dark border border-bottom-0 border-left-0 border-top-0 bg-light search-height">
					...
					<form class="form-group text-left mx-auto" enctype="multipart/form-data" method="post" action="index.php?p=1" accept-charset="utf-8">
				  ...
				  if (($_POST["search"])!=''){
					...
					switch ($filtre):
								case 'numero':
                                    ...
                                    break;
                                case 'nom':
                                    $print='Résultats De La Recherche Selon le Nom : ';
                                    break;
                                case 'prenom':
                                    $print='Résultats De La Recherche Selon le Prénom : ';
                                    break;
                                case 'motif':
                    ...
                    <div class="row col-lg-12 text-center font-weight-bold mx-1" style="border-bottom: solid 2px grey;">
                        ...
                        <div class=" col-lg-3 d-none d-lg-block">
                            Motif <?php echo $titre4;?>
                        </div>
                        <div class="col-lg-1 col-md-3">
                            Date <?php echo $titre5;?>
                        </div>
		...
		include("inc/bcl.consultations.inc.php");
