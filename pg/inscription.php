...
$verification="SELECT id FROM patient where id = '$id'";
...
// sql 
$ajout="INSERT INTO patient (id,password,nom,prenom,age,adresse,email,numtel) VALUES ('$id','$password','$nom','$prenom','$age','$adresse','$email','$numtel')";

$mysqli->query($ajout) or die ('Erreur '.$ajout.' '.$mysqli->error);

	echo "<script type=\"text/javascript\">alert('Le compte a été créé avec succés');</script>\n";
    echo "<script type=\"text/javascript\">window.close();</script>\n";
?>	
<meta http-equiv='Refresh' content='0; URL=index.php?p=5'>
<?php
...
?>
        <div class="row px-2">
            ...
            <div id="haut" class="col-lg-6 p-3 my-2" style="background-color: white;">
                ...
                <form enctype="multipart/form-data" method="post" action="index.php?p=9" accept-charset="utf-8">
                    <fieldset class="border rounded border-danger p-2 mb-2">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <input class="form-control" name="id" placeholder="Entrer votre Identifiant..." type="name" required="required" minlength="8">
                            </input>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <input class="form-control" name="nom" placeholder="Entrer le Nom..." type="name" required="required">
                            </input>
                        </div>
                        <div class="form-group col-lg-6">
                            <label for="prénom">
                            ...
                            <input class="form-control" name="prenom" placeholder="Entrer le prénom..." type="name" required="required">
                            </input>
                        </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="age" placeholder="Entrer l'age..." type="text" pattern="^0?[0-9]?[0-9]$|^(100)$" required="required">
                        </input>
                        <small class="form-text text-muted">
                            Age Entre 0 Et 100.
                        </small>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <textarea class="form-control" name="adresse" placeholder="Entrer l'Adresse..." type="adress" required="required" minlength="10"></textarea>
                        <small class="form-text text-muted">
                    ...
                    <div class="form-group col-lg-5">
                        ...
                        <input class="form-control" name="numtel" placeholder="Entrer Le Numéro de téléphone" type="text" pattern="^[0]{1}[0-9]{9}$" required="required">
                        </input>
                        <small class="form-text text-muted">
                    ...
                    <div class="form-group col-lg-7">
                        ...
                        <input class="form-control" name="email" placeholder="Entrer L'e-mail..." type="email" required="required">
                        </input>
                    </div>
                    </div>
                    </fieldset>
                ...
                <div class="float-right">
                    <a class="btn btn-info" title="Annuler..." href="index.php?p=6"><i class="fas fa-arrow-left"></i> Annuler</a>
                    <button type="submit" title="S'inscrire" class="btn btn-info"><i class="fas fa-save"></i> S'inscrire</button>
                </div>
                </form>
            </div>
            <div class="col-lg-3">
